        ...
        <div>
            <div className="bg d-flex align-items-center flex-row">
                <div className="text-hp-wrapper text-center p-5">
                    <div className="col-12 col-md-8 mx-auto">
                        <h1 className="text-light">BantenVerse</h1>
                        <p className="text-light mt-3">Mau informasi tentang seputar Provinsi Banten? Yuk silakan pencet tab dibawah untuk menuju apa yang Anda butuhkan</p>
                    </div>
            ...
            <div className="text-center m-4">
                <div className="border border-dark col-12 col-lg-4 mx-auto my-4 p-1">
                    <h2 className="bg-dark m-0 py-2 text-light">Peta Sebaran COVID19</h2>
                    <FadeIn>   
                        <Loader
                ...
                <h2 className="text-dark">Peta Ibu Kota Banten dan Sekitarnya</h2>
                <Map
